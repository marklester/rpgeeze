 ...
 */
public class ActionMenuView extends HighlightableView<ActionMenuView.State> {
	...
	public ActionMenuView(GameManager manager) {
		super(manager);
		...
		Iterator<String> names = new ArrayIterator<String>("Talk", "Attack", "Use Skill", "Use Item");
