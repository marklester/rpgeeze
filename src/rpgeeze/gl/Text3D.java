...
public class Text3D extends GLObject {
	private String text;
	...
	public Text3D(String text, TextRenderer renderer, float scaleFactor) {
		this(text, Color.BLACK, renderer, scaleFactor);
	}
	
	public Text3D(String text, Color color, TextRenderer renderer, float scaleFactor) {
		super(color);
		this.text = text;
