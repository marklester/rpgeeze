...
public class Lesson07 extends KeyAdapter implements GLEventListener {
	...
	public void init(GLAutoDrawable drawable) {
        ...
        textures[0] = loadTexture(getClass().getClassLoader().getResourceAsStream("res/crate.png"));
        ...
        textures[1] = loadTexture(getClass().getClassLoader().getResourceAsStream("res/crate.png"));
        ...
        textures[2] = loadTexture(getClass().getClassLoader().getResourceAsStream("res/crate.png"));
